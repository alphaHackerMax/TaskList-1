...
public final class MyCat {
    ...
    //private List<Object> unmodifiableArrKitty;
    ...
    public MyCat(String CatName, String CatColor, List<Object> ArrKitty) {
        ...
        //this.arrKitty = ArrKitty;  // "shallow clone" not guarantee for immutable - will not use!
        /**
    ...
    /*
    @Deprecated
    public static MyCat createNewCat(String CatName, String CatColor, List<Object> ArrKitty) {
        return new MyCat(CatName, CatColor, ArrKitty);
    }

    @Deprecated
    public static MyCat createOldCate(String CatName, String CatColor, List<Object> ArrKitty, String BirthDate) {
        return new MyCat(CatName, CatColor, ArrKitty, BirthDate);
    }
     */
    ...
    public List getListKitty() {
        //return new ArrayList(arrKitty);  // return a copy of the list
